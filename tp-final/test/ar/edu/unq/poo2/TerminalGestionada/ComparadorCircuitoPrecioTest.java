...
class ComparadorCircuitoPrecioTest {
	...
	void elMenorCircuito() {
		when(circ1.getPrecio()).thenReturn(100.0);
		when(circ2.getPrecio()).thenReturn(40.0);
	...
	void circuitosIguales() {
		when(circ1.getPrecio()).thenReturn(150.0);
		when(circ2.getPrecio()).thenReturn(150.0);
	...
	void elSegundoEsMayor() {
		when(circ1.getPrecio()).thenReturn(80.0);
		when(circ2.getPrecio()).thenReturn(90.0);
		assertEquals(-1, comparador.comparar(circ1, circ2));
